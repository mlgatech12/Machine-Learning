...
public class Marketing_Final {
    ...
    private static int inputLayer = 51, hiddenLayer = 10, outputLayer = 1, trngIterations = 1000;
    ...
    public static void main(String[] args) {
        ...
        oa[1] = new SimulatedAnnealing(1e2, 0.65, nnop[1]);
        oa[0] = new StandardGeneticAlgorithm(75,35,7,nnop[2]);
        
        int[] iters = {1000};
        //int[] iters = {2,5};
        String header = "";
        header = "Algo" + "," + "Iterations" + "," + "TrainingAccuracy" + "," + "TrainingTime" + "," + "TestingTime" ;
        write_output_to_file("Optimization_Results", "mktg_final_train_results.csv", header, true);

        header = "Algo" + "," + "Iterations" + "," + "TestingAccuracy" + "," + "TestingTime" ;
        write_output_to_file("Optimization_Results", "mktg_final_test_results.csv", header, true);
        ...
        for (int iter : iters) {
	        ...
	        for(int i = 0; i < oa.length; i++) {
	            ...
	            write_output_to_file("Optimization_Results", "mktg_final_train_results.csv", results, true);
                ...
                write_output_to_file("Optimization_Results", "mktg_final_test_results.csv", results, true);
